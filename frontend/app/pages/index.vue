  ...
  <div>
    ...
    <section id="experience" class="container-page scroll-mt-24 py-20">
      <AppSectionTitle
        ...
        description="Three years of designing, building and maintaining WordPress websites — from custom themes and plugins to WooCommerce stores and hosting management."
      />
